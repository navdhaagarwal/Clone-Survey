...
@Component("assignmentmasterChangeExecutionHelper")
public class AssignmentMatrixChangeExecutionHelper extends MasterChangeExecutionHelper {
	...
	public void preProcess(MasterChangeEntityHolder oldEntity, MasterChangeEntityHolder newEntity) {
		AssignmentMaster oldMaster = (AssignmentMaster)oldEntity.getRootEntity();
		AssignmentMaster newMaster = (AssignmentMaster)oldEntity.getRootEntity();
