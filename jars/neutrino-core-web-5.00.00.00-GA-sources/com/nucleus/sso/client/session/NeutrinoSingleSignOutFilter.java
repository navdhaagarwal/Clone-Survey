...
/*
 * 
 * Custom implementation of org.jasig.cas.client.session.SingleSignOutFilter
 * 
 */
		
		
public class NeutrinoSingleSignOutFilter extends AbstractConfigurationFilter{

	private static final NeutrinoSingleSignOutHandler HANDLER = new NeutrinoSingleSignOutHandler();
    ...
    protected static NeutrinoSingleSignOutHandler getCustomSingleSignOutHandler() {
        return HANDLER;
    }
