 ...
 * 
 * 
 * Custom implementation of org.jasig.cas.client.session.SingleSignOutHandler
 * 
 */
public class NeutrinoSingleSignOutHandler {
    ...
    private NeutrinoSessionMappingStorage sessionMappingStorage = new CacheBackedSessionMappingStorage();
    ...
    public void setSessionMappingStorage(final NeutrinoSessionMappingStorage storage) {
    ...
    public NeutrinoSessionMappingStorage getSessionMappingStorage() {
    ...
    private void destroySession(final HttpServletRequest request) {
        ...
        if (CommonUtils.isNotBlank(token)) {
        	// replace this method by remove session by mappingid and expire 
             this.sessionMappingStorage.removeSessionByMappingId(token, request);
