...
@Transactional
@Controller
@RequestMapping(value = "/ModelMetaDataGrid")
public class ModelMetaDataGridController extends BaseController {
    ...
    private final static String                masterId      = "ModelMetaData";
    ...
    @MonitoredWithSpring(name = "MMDGC_ENTITY_UPDATE_INFO_LIST")
    public @ResponseBody
    ...
    public Map<String, Object> getEntityData() {
        ...
        childData.put("entityList", modelMetaDataList);
        return childData;
    }
