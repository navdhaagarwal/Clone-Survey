...
public class EntityUriConfigCachePopulator extends FWCachePopulator {
	...
	@Override
	public void init() {
		BaseLoggers.flowLogger.debug("Init Called : EntityUriConfigCachePopulator");
	}
	...
	public void build(Long tenantId) {
		configurationService.buildConfigPropKeyByEntityUriCache();
	}
	...
	public String getNeutrinoCacheName() {
		return FWCacheConstants.ENTITYURI_PROPKEY_CONFIG_MAP;
	}
