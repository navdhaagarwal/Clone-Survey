...
public class EmailCommunication extends Communication {
    ...
    private static final long serialVersionUID = 2587983932154147750L;

    @OneToOne(cascade = CascadeType.ALL,fetch=FetchType.LAZY)
    private EMailInfo         contactEmail;
     ...
     */
    public EMailInfo getContactEmail() {
        return contactEmail;
    }
     ...
     */
    public void setContactEmail(EMailInfo contactEmail) {
