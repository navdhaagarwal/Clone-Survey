 ...
 * 
 */
public class InheritableThreadLocalBatchContextHolderStrategy implements BatchContextHolderStrategy {

    private static final ThreadLocal<BatchProcessContext> contextHolder = new InheritableThreadLocal<BatchProcessContext>();
