...
public interface AddOnDataProviderForCommunicationGeneration {
	/**
	 * 
	 ...
	 */
	void provideDataForCommunicationGeneration(Map<String,Object> contextMap, Map<String,Object> localCacheMap);
}
